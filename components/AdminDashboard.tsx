...
interface Props {
  teachers: Teacher[];
  setTeachers: (t: Teacher[]) => void; // Add this back
  submissions: WeeklySubmission[];
  setSubmissions: (s: WeeklySubmission[]) => void; // Add this back
...
const AdminDashboard: React.FC<Props> = ({ 
  ...
  const defaultersByClass = useMemo(() => {
    ...
    missingTeachers.forEach(t => {
      // Use optional chaining in case assignedClasses doesn't exist
  ...
  // Simple debug - remove this in production
  useEffect(() => {
    console.log('AdminDashboard mounted with:', {
      teachersCount: teachers.length,
      submissionsCount: submissions.length,
      missingTeachersCount: missingTeachers.length,
      pendingRequestsCount: pendingRequests.length
    });
  }, [teachers.length, submissions.length, missingTeachers.length, pendingRequests.length]);
